# Django settings for pshare project.
...
SECRET_KEY = 'crs@alr4--qi!5ar_mwx$65abvlc6e)an*-yr$$%d2ip(xc9hh'
...
ROOT_URLCONF = 'pshare.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'pshare.wsgi.application'
